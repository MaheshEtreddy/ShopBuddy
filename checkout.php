...
}elseif ( isset($_POST['submit']) && $_POST['submit'] == 'UpdateProfile' ){
...
<div class="container">
		<div class="row" style="margin-top: 30px">
			...
			?></div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="country" required="required">
							<option value="<?=$udata['country']?>"><?=$udata['country']?></option>
				...
				<br />
					<input class="btn btn-primary" type="submit" value="Continue" name="UpdateProfile">
