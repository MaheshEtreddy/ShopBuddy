...
<title>Login - Learn Testing Online</title>
...
<div id="wrapper">
	...
	<form name="login-form" class="login-form" action="" method="post">
		...
		<div class="header">
		<h1>Login to Learn Testing Online</h1>
		...
		<div><input type="submit" name="submit" value="Login" class="button" /></div><hr />
		<div>&nbsp;</div>
		<div style="color: red;"> &larr; <a href="index.php"> Back to learntestingonline.com</a></div>
		</div>
