		...
		<div class="navbar-inner">
			<div class="container">
				...
				<a class="brand" href="/index.php"><img
					src="../shopbuddy/img/shopbuddy_logo.png" width="200" height="200"></img></a>
				<div class="nav-collapse collapse">
					<ul class="nav">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown">E-Commerce <b class="caret"></b></a>
					...
					<form class="form login-form" action="" method="post">
						...
						<div>
							<label>Username</label> <input id="Username" name="Username"
								...
								class="checkbox inline"> <input type="checkbox" id="RememberMe"
								value="option1"> Remember me
							</label> <br />
							<br /> <input type="submit" name="submit" value="Login"
								class="btn btn-success">
						</div>
						<br /> <a href="#">register</a>&nbsp;&#124;&nbsp;<a href="#">forgot
							password?</a>
					</form>
				</div>
			</div>
	...
	<footer id="footer" class="vspace20">
		<div class="container">
			...
			<div class="row">
				...
				<div class="span6">
					<a class="pull-right" href="http://www.codefuel.com"
						target="_blank">credits by Code Fuel - (by) Mahesh & Vamsy</a>
				</div>
			</div>
		</div>
	</footer>
